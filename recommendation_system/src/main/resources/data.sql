...
insert into tb_role (created, status, updated, name) VALUES ('2023-03-29 02:27:35', 'ACTIVE', '2023-03-29 02:27:41', 'ROLE_USER');
insert into tb_role (created, status, updated, name) VALUES ('2023-03-29 02:27:35', 'ACTIVE', '2023-03-29 02:27:41', 'ROLE_ADMIN');

/*Пользователь 'kulonbekov' с ролем (ROLE_ADMIN)*/
insert into tb_user(created,status,updated,age, email, gender, password, username)
VALUES ('2023-03-29 02:28:38.593', 'ACTIVE', '2023-03-29 02:28:38.593', 29, 'mirbek@gmail.com','MALE', '$2a$04$j8hS2sCsqpTzZBYPPRpBnubIuhee0Y1DmYOrwfTc9BO56Td7IiYW2', 'mirbek');

/*Пользователь 'adil' с ролем (ROLE_USER)*/
insert into tb_user(created,status,updated,age, email, gender, password, username)
VALUES ('2023-03-29 02:28:38.593', 'ACTIVE', '2023-03-29 02:28:38.593', 25, '1sehami4053@djpich.com','MALE', '$2a$10$DXlADomsliqPm44E43IS0O34vSqpBD2xHIUAhf0gPnbC3vL4bTGXy', 'adil');
...
insert into tb_genre(created,status,updated,name)VALUES ('2023-03-29 02:28:38.593','ACTIVE', '2023-03-29 02:28:38.593','Классическая музыка');
insert into tb_genre(created,status,updated,name)VALUES ('2023-03-29 02:28:38.593','ACTIVE', '2023-03-29 02:28:38.593','Hip Hop');
insert into tb_genre(created,status,updated,name)VALUES ('2023-03-29 02:28:38.593','ACTIVE', '2023-03-29 02:28:38.593','Индийская поп-музыка');
insert into tb_genre(created,status,updated,name)VALUES ('2023-03-29 02:28:38.593','ACTIVE', '2023-03-29 02:28:38.593','Rap');
insert into tb_genre(created,status,updated,name)VALUES ('2023-03-29 02:28:38.593','ACTIVE', '2023-03-29 02:28:38.593','Поп-музыка');
